...
VSIM_PATH?	=.
PULP_PATH?	=../..
NCSIM_LIBS_PATH	= vcs_lib
IPS_PATH	=../ips
RTL_PATH	=../rtl
TB_PATH		=../tb
LIB_PATH	=vcs_lib/$(LIB_NAME)

XRUN 		?= xrun

# commands
ifndef VERBOSE
	SVLOG_CC= vcs -sverilog -full64  -assert svaext +error+100 -timescale=1ns/1ps
